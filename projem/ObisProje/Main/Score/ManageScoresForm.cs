    ...
    public partial class ManageScoresForm : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (button == "score")
            {
                ...
                sql.Open();
                sqlCommand.Parameters.AddWithValue("@student_id", studentListData.Rows[rowindex].Cells[9].Value);
                sqlCommand.Parameters.AddWithValue("@score_course", studentListData.Rows[rowindex].Cells[1].Value);
        ...
        private void AddScore_Click(object sender, EventArgs e)
        {
            ...
            if (readerHasRows)
            {
                MessageBox.Show("Zaten Eklenmiş!!");
            }
            else
            {
